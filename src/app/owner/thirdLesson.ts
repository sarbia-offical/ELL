...
export const wordList: Array<IWordInfo> = [
  {
    word: {
      ...
      translate: ["n. 父亲/爸爸/天父", "v. 成为父亲/做父亲"],
    },
    phraseList: [
      {
  ...
  },
  {
    word: {
      ...
      translate: ["vt. 开始/启动", "vi. 出发", "n. 开始;起点"],
    },
    phraseList: [
      {
