...
export const wordList: Array<IWordInfo> = [
  ...
  },
  {
    word: {
      ...
      translate: ["n. 立场/态度/观点", "v. 站立/直立/忍受"],
    },
    phraseList: [
        {
            "originText": "stand by",
  ...
  },
  {
    word: {
      originalWord: "bed",
      phoneticSymbol: "[bed]",
      translate: ["n. 床", "v. 把…固定在；与（某人）发生性关系"],
    },
    phraseList: [
        {
...
export const swaggyList: Array<IWordInfo> = [
  ...
  {
    word: {
      originalWord: "Where did you get...",
      phoneticSymbol: "",
      translate: ["你从哪弄来的..."],
    },
    phraseList: [
...
export const secondLesson: ILessonInfo = {
  title: "Lesson Two [æ]/[e]",
  swaggy: {
    originText:
      "Today is the first day of my [0], I’m going to take my [1] home. MoM, dad! On! sweet heart, you [2] came back, we [3] you so much! What! [4] the dog? [5] now! You are not [6] step into this room with that dog!",
    points: [
      {
        word: {
          originalWord: "vacation",
